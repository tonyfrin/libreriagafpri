...
export const generalChangeGalleryPhotoWebSockets = async ({
  e,
  setSubmitting,
  changeError,
  setPhoto,
  ...
  validation,
  selectedOptions,
}: GeneralChangeGalleryPhotoWebSocketsProps): Promise<void> => {
  ...
  ws.onmessage = (event): void => {
    ...
    if (
      ...
      if (receivedData.success) {
        const updatedOptions = [...selectedOptions, receivedData.cleanImageUrl];
