...
const entityBudgetSearchStylesContainer = () => css`
  max-width: 1150px;
  margin: auto;
...
export const EntityBudgetSearch = ({
  use,
  useBudget,
  ...
  listProps,
}: EntityBudgetSearchProps): JSX.Element => {
    ...
    return (
      <div className={css(optionButtonContainerStyle)}>
        <Button
          title="Seleccionar"
          buttonProps={{
            onClick: () => useBudget.pages.actions.selectEntity(id),
          }}
          styles={{
            fontSize: '10px',
          }}
  ...
  return (
    <>
      <div className={cx(entityBudgetSearchStylesContainer())}>
