...
const entitySearchStylesContainer = () => css`
  max-width: 1150px;
  margin: auto;
...
export const EntitySearch = ({
    ...
    return (
      <div className={css(optionButtonContainerStyle)}>
        <Button
          title="Seleccionar"
          buttonProps={{
            onClick: () => useOrder.pages.actions.selectEntity(id),
          }}
          styles={{
            fontSize: '10px',
          }}
  ...
  return (
    <>
      <div className={cx(entitySearchStylesContainer())}>
        ...
        >
          <>
            ...
            <Button
              title="Agregar"
              buttonProps={{
                onClick: () => useOrder.pages.actions.onAddEntity(),
              }}
            />
          </>
        </ContainerButton>
