...
const entityIncomeSearchStylesContainer = () => css`
  max-width: 1150px;
  margin: auto;
...
export const EntityIncomeSearch = ({
  use,
  useIncome,
  ...
  listProps,
}: EntityIncomeSearchProps): JSX.Element => {
    ...
    return (
      <div className={css(optionButtonContainerStyle)}>
        <Button
          title="Seleccionar"
          buttonProps={{
            onClick: () => useIncome.pages.actions.selectEntity(id),
          }}
          styles={{
            fontSize: '10px',
          }}
  ...
  return (
    <>
      <div className={cx(entityIncomeSearchStylesContainer())}>
        ...
        >
          <>
            ...
            <Button
              title="Agregar"
              buttonProps={{
                onClick: () => useIncome.pages.actions.onAddEntity(),
              }}
            />
          </>
        </ContainerButton>
