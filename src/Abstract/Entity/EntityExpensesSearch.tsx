...
const entityExpensesSearchStylesContainer = () => css`
  max-width: 1150px;
  margin: auto;
...
export const EntityExpensesSearch = ({
  use,
  useExpenses,
  ...
  listProps,
}: EntityExpensesSearchProps): JSX.Element => {
    ...
    return (
      <div className={css(optionButtonContainerStyle)}>
        <Button
          title="Seleccionar"
          buttonProps={{
            onClick: () => useExpenses.pages.actions.selectEntity(id),
          }}
          styles={{
            fontSize: '10px',
          }}
  ...
  return (
    <>
      <div className={cx(entityExpensesSearchStylesContainer())}>
        ...
        >
          <>
            ...
            <Button
              title="Agregar"
              buttonProps={{
                onClick: () => useExpenses.pages.actions.onAddEntity(),
              }}
            />
          </>
        </ContainerButton>
