...
var InitProjects = exports.InitProjects = function InitProjects(_ref) {
  ...
  var paginatedCurrencies = use.paginations.actions.getPaginated(projects, use.paginations.states.currentPage, use.paginations.states.itemsPerPage);
