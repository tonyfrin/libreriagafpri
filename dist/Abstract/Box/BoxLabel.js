...
var boxLabelContainerStyles = function boxLabelContainerStyles(styles) {
...
var boxLabelContentStyles = function boxLabelContentStyles(styles) {
...
var boxLabelContentItemsStyles = function boxLabelContentItemsStyles(styles) {
...
var boxLabelContentButtonStyles = function boxLabelContentButtonStyles(styles) {
...
var boxLabelContentTitleStyles = function boxLabelContentTitleStyles(styles) {
...
var BoxLabel = exports.BoxLabel = function BoxLabel(_ref) {
  ...
  return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement("div", (0, _extends2["default"])({
    className: (0, _css.cx)(boxLabelContainerStyles(containerStyles), containerClassName)
  }, restContainerProps), items.map(function (item, index) {
    return /*#__PURE__*/_react["default"].createElement("div", (0, _extends2["default"])({
      key: "".concat(item, "-").concat(index),
      className: (0, _css.cx)(boxLabelContentStyles(contentStyles), contentClassName)
    }, restContentProps), /*#__PURE__*/_react["default"].createElement("div", (0, _extends2["default"])({
      className: (0, _css.cx)(boxLabelContentItemsStyles(contentItemsStyles), contentItemsClassName)
    }, restContentItemsProps), /*#__PURE__*/_react["default"].createElement("span", (0, _extends2["default"])({
      className: (0, _css.cx)(boxLabelContentButtonStyles(contentButtonStyles), closeButtonClassName),
      onClick: function onClick() {
        return removeItem(index);
      }
    }, restCloseButtonProps), "x"), /*#__PURE__*/_react["default"].createElement("span", (0, _extends2["default"])({
      className: (0, _css.cx)(boxLabelContentTitleStyles(contentTitleStyles), titleClassName)
    }, restTitleProps), item)));
  })));
};