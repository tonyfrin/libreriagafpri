...
exports.EntityAccountsReceivableSearch = void 0;
...
var entityAccountsReceivableSearchStylesContainer = function entityAccountsReceivableSearchStylesContainer() {
  return (0, _css.css)(_templateObject2 || (_templateObject2 = (0, _taggedTemplateLiteral2["default"])(["\n  max-width: 1150px;\n  margin: auto;\n  background-color: #fff;\n  padding: 20px;\n  border-radius: 10px;\n"])));
};
var EntityAccountsReceivableSearch = exports.EntityAccountsReceivableSearch = function EntityAccountsReceivableSearch(_ref) {
  var _paginated$map;
  var use = _ref.use,
    useAccountsReceivable = _ref.useAccountsReceivable,
    ...
    return /*#__PURE__*/_react["default"].createElement("div", {
      ...
      buttonProps: {
        onClick: function onClick() {
          return useAccountsReceivable.pages.actions.selectEntity(id);
        }
      },
      styles: {
        fontSize: '10px'
  ...
  return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement("div", {
    className: (0, _css.cx)(entityAccountsReceivableSearchStylesContainer())
    ...
    buttonProps: {
      onClick: function onClick() {
        return useAccountsReceivable.pages.actions.onAddEntity();
      }
    }
  })))));
};