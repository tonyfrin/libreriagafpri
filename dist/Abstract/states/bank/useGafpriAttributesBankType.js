...
function useGafpriAttributesBankType(_ref) {
  var _useSites$states$site, _useCurrencies$states;
  ...
  var sitesIdOptions = ((_useSites$states$site = useSites.states.sites.data) === null || _useSites$states$site === void 0 || (_useSites$states$site = _useSites$states$site.items) === null || _useSites$states$site === void 0 ? void 0 : _useSites$states$site.map(function (item) {
    return {
