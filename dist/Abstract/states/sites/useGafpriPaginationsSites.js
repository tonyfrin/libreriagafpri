...
exports.useGafpriPaginationsSites = void 0;
...
var useGafpriPaginationsSites = exports.useGafpriPaginationsSites = function useGafpriPaginationsSites() {
  ...
  var filterByName = function filterByName(search, items) {
    if (items) {
