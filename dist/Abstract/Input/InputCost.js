...
var InputCost = exports.InputCost = function InputCost(_ref) {
  var changeCost = _ref.changeCost,
    props = _ref.props,
  ...
  return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement(_Input.Input, {
    ...
    inputProps: _objectSpread({
      ...
      min: '0',
      step: '0.1',
      id: "".concat(_constants.COST_INPUT).concat(inputId),
      title: 'Costo',
      onChange: function onChange(event) {
        return changeCost(event.currentTarget.value);
      }
