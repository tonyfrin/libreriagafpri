...
var Products = exports.Products = function Products(_ref) {
  var use = _ref.use,
  ...
  }, /*#__PURE__*/_react["default"].createElement(_Abstract.InitProducts, {
    use: use,
    sitesOptions: sitesOptions
  })), use.pages.states.isAdd && /*#__PURE__*/_react["default"].createElement(_Abstract.FadeIn, {
    keyName: "add",
    isVisible: use.pages.states.isAdd
  }, /*#__PURE__*/_react["default"].createElement(_Abstract.ProductsForm, {
    use: use,
    formType: "add"
